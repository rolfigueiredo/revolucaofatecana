...
if(isset($_POST["add"]) && $_POST["add"] == "Cadastrar"){
	$cad = $objEvento->CadEvento($_POST["data"],$_POST['evento'],$_POST['descricao']);
    if ($cad>0){
        ...
        if (!empty($_FILES['img'])){
            ...
            if ($upload->salvar()=="Sucesso"){
                ...
                if ($img=="ok"){
                    header("Location:evento_cad.php?cad=ok");
                    die();
                }
            }
        }
        ...
        <div class="content-inner">
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">Cadastrar Evento</h2>
                </div>
            </header>
            <?if(isset($_GET["cad"])){?>
                                ...
                                <div class="left-col retirar_borda d-flex align-items-center justify-content-between">
                                    <div class="project-title d-flex align-items-center">
                                        <div class="text">
                                            ...
                                            <h3 class="h4">Evento Cadastrado com sucesso!</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="form-inline">
                                                <div class="col-sm-12 col-md-5 format-box-forms-ini">
                                                    <div class="form-group-material">
                                                        ...
                                                        <label for="produto" class="label-material">Nome Evento</label>
                                                    </div>
                                                </div>
