    ...
    if ($cad>0){
        if (!empty($_FILES['img'])){
            ...
            if ($upload->salvar()=="Sucesso"){
                ...
                if ($img=="ok"){
                    header("Location:produtos.php?cad=ok");
                    die();
                }
            }
        }
    }
    header("Location:produtos.php?pesq=$pesq&cad=ok");
}
?>
<!DOCTYPE html>
<?php
        ...
        <div class="content-inner">
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">Alterar Produto</h2>
                </div>
            </header>
            <?if(isset($_GET["cad"])){?>
                                        ...
                                        <div class="col-sm-12">
                                                ...
                                                <div class="form-group-material select">
                                                    ...
                                                    <select id="categ" name="categ" class="input-material" required />
                                                        ...
                                                        <?foreach ($categs as $row) {
                                                            ...
                                                            if ($objProduto->getCodCategoria()==$row[0])
                                                                echo " selected";
                                                            echo " />".$row[1]."</option>\n";
                                                        } ?>
                                                    </select>
                                            ...
                                            <div class="form-inline">
                                                <div class="col-sm-12 col-md-5 format-box-forms-ini">
                                                    <div class="form-group-material">
                                                        <input id="produto" type="text" name="produto" value="<?=$objProduto->getNomeProduto()?>" maxlength="50" class="input-material" required />
                                                        <label for="produto" class="label-material">Nome Produto</label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-7 format-box-forms-ini">
                                                    <div class="form-group-material">
                                                        <input id="valor" type="text" name="valor" value="<?=$objProduto->getValorProduto()?>" maxlength="10" class="input-material" required />
                                            ...
                                            <div class="form-inline">
                                                <div class="col-sm-12 format-box-forms-ini">
                                                    <div class="form-group-material">
                                                        <textarea id="descricao" name="descricao" cols="5" class="input-material" required /><?=$objProduto->getDescProduto()?></textarea>
